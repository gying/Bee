    ...
    switch (msgBody.messageBodyType) {
        case eMessageBodyType_Text: {
            ...
            if (_chat.sendFromSelf) {
                ...
                if (message.cell_width) {
                    if (message.cell_width.doubleValue >= [[UIScreen mainScreen] bounds].size.width - 185.0) {
                        conL =  100.0;
                    } else {
                        conL = 100.0 + ([[UIScreen mainScreen] bounds].size.width - 185.0 - message.cell_width.doubleValue);
                    }
                }else {
                    conL =  100.0;
        ...
        case eMessageBodyType_Image: {
            ...
            if (_chat.sendFromSelf) {
                ...
                float conL =  [[UIScreen mainScreen] bounds].size.width- body.thumbnailSize.width - 74.0;
                [self.selfViewConLeft setConstant:conL];
